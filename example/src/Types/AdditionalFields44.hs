...
module Types.AdditionalFields44 where
...
data AdditionalFields44 = AdditionalFields44
  { amazon :: Amazon
  }
  deriving (Show, Eq)

instance FromJSON AdditionalFields44 where
  parseJSON = withObject "AdditionalFields44" $ \obj -> do
    amazon <- obj .: "amazon"
    pure $ AdditionalFields44{..}

instance ToJSON AdditionalFields44 where
  toJSON AdditionalFields44{..} =
    object [
      "amazon" .= amazon
    ]
