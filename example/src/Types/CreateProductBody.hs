...
module Types.CreateProductBody where
...
data CreateProductBody = CreateProductBody
  { product :: CreateProduct
  }
  deriving (Show, Eq)

instance FromJSON CreateProductBody where
  parseJSON = withObject "CreateProductBody" $ \obj -> do
    product <- obj .: "product"
    pure $ CreateProductBody{..}

instance ToJSON CreateProductBody where
  toJSON CreateProductBody{..} =
    object [
      "product" .= product
    ]
